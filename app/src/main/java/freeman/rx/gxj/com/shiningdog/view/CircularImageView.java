...
import freeman.rx.gxj.com.shiningdog.R;
...
public class CircularImageView extends ImageView {
	...
	public CircularImageView(Context context, AttributeSet attrs, int defStyle)	{
		...
		autoShine = new Handler(){
			@Override
			public void handleMessage(Message msg) {
				isSelected = !isSelected;
				autoShine.removeCallbacks(null);
				invalidate();

				autoShine.sendEmptyMessageDelayed(1,1000);
	...
	private void init(Context context, AttributeSet attrs, int defStyle){
		...
		TypedArray attributes = context.obtainStyledAttributes(
				attrs, R.styleable.CircularImageView, defStyle, 0);
		...
		if(hasBorder) {
			...
			setBorderWidth(attributes.getDimensionPixelOffset(
					R.styleable.CircularImageView_border_width, defaultBorderSize));
		...
		if(hasSelector) {
			...
			setSelectorStrokeWidth(attributes.getDimensionPixelOffset(
					R.styleable.CircularImageView_selector_stroke_width, defaultSelectorSize));
			setSelectorStrokeColor(attributes.getColor(
					R.styleable.CircularImageView_selector_stroke_color, Color.BLUE));
		}
